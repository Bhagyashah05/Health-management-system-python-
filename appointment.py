...
class Application:
    def __init__(self, master):
        ...
        self.left = Frame(master, width=800, height=720, bg='turquoise')
        ...
        self.heading = Label(self.left, text="Hospital Appointments", font=('arial 40 bold'), fg='black', bg='turquoise')
        self.heading.place(x=0, y=0)
        # patients name
        self.name = Label(self.left, text="Patient's Name", font=('arial 18 bold'), fg='black', bg='turquoise')
        self.name.place(x=0, y=100)

        # age
        self.age = Label(self.left, text="Age", font=('arial 18 bold'), fg='black', bg='turquoise')
        self.age.place(x=0, y=140)

        # gender
        self.gender = Label(self.left, text="Gender", font=('arial 18 bold'), fg='black', bg='turquoise')
        self.gender.place(x=0, y=180)

        # location
        self.location = Label(self.left, text="Location", font=('arial 18 bold'), fg='black', bg='turquoise')
        self.location.place(x=0, y=220)

        # appointment time
        self.time = Label(self.left, text="Appointment Time", font=('arial 18 bold'), fg='black', bg='turquoise')
        self.time.place(x=0, y=260)

        # phone
        self.phone = Label(self.left, text="Phone Number", font=('arial 18 bold'), fg='black', bg='turquoise')
        ...
        self.submit = Button(self.left, text="Add Appointment", width=20, height=2,fg='white', bg='black', command=self.add_appointment)
        ...
        self.logs = Label(self.right, text="Logs", font=('arial 28 bold'), fg='white', bg='turquoise')
