...
class Application:
    def __init__(self, master):
        self.master = master
        # heading label
        self.heading = Label(master, text="Update Appointments",  fg='turquoise', font=('helvetica 40 bold'))
        self.heading.place(x=150, y=0)

        # search criteria -->name 
        self.name = Label(master, text="Enter Patient's Name", font=('helvetica 18 bold'))
    ...
    def search_db(self):
        ...
        self.uname = Label(self.master, text="Patient's Name", font=('helvetica 18 bold'))
        self.uname.place(x=0, y=140)

        self.uage = Label(self.master, text="Age", font=('helvetica 18 bold'))
        self.uage.place(x=0, y=180)

        self.ugender = Label(self.master, text="Gender", font=('helvetica 18 bold'))
        self.ugender.place(x=0, y=220)

        self.ulocation = Label(self.master, text="Location", font=('helvetica 18 bold'))
        self.ulocation.place(x=0, y=260)

        self.utime = Label(self.master, text="Appointment Time", font=('helvetica 18 bold'))
        self.utime.place(x=0, y=300)

        self.uphone = Label(self.master, text="Phone Number", font=('helvetica 18 bold'))
